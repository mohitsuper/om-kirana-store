    ...
    <section className="py-10 sm:py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="text-center mb-3 sm:mb-14">
          <span className="text-sm text-orange-500 font-semibold uppercase tracking-[3px]">
            Visit Us
          </span>

          <h2 className="text-xl sm:text-4xl font-bold text-[#16325B] mt-3">
            Get In Touch With Us
          </h2>

          <p className="text-sm sm:text-base text-gray-500 mt-4 max-w-2xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2  gap-5 sm:gap-10 items-center">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-3  sm:p-6 flex items-center sm:items-start gap-5 hover:shadow-xl duration-300">

              <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-full bg-orange-100 flex items-center justify-center text-orange-500 text-md sm:text-2xl">
                <i className="fa-solid fa-location-dot"></i>
              </div>

              <div>
                <h3 className="text-lg sm:text-xl font-bold text-[#16325B]">
                  Office Address
                </h3>
          ...
          <div className="rounded-3xl overflow-hidden shadow-xl h-[300px] sm:h-[550px]">
